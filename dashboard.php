...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE `dashboarddesign`.`userprofile` SET `username` = '$username', `email` = '$email', `password` = '$password' , `phone` = '$phone' WHERE `userprofile`.`id` = $id ;
";
...
<body class="bg-gray-100">
    ...
    <div class="bg-white shadow-lg rounded-lg p-5 animate__animated animate__fadeIn">
      ...
      <form id="profileForm" method="post">
        ...
        <div class="mt-4 text-end">
          <button type="submit" id="saveBtn" name="submit" class="btn btn-success d-none">
  ...
  <script>
    ...
    //     profileData = { name: "", email: "", phone: "", password: "" };
    //     populateProfile();
